...
const historikk: HistorikkType[] = [
	{ mal: 'hei på deg', endretAv: 'BRUKER', dato: '2019-04-10T06:19:30.284' },
	{ mal: null, endretAv: '', dato: null },
	{
...
const forventetKombinertHistorikk = [
	{ mal: 'hei på deg', tekst: 'Jeg skal tilbake til ny jobb', endretAv: 'BRUKER', dato: '2019-04-10T06:19:30.284' },
	{
		mal: '',
		tekst: 'Jeg skal tilbake til ny jobb',
		endretAv: 'BRUKER',
